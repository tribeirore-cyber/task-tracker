error id: file://<WORKSPACE>/src/main/java/br/thomas/App.java:java/lang/String#stripLeading().
file://<WORKSPACE>/src/main/java/br/thomas/App.java
empty definition using pc, found symbol in pc: java/lang/String#stripLeading().
...
public class App {
    ...
    private static void addNewTask(String taskDescription, List<Task> tasks) {
        Task task = new Task();
        String description = taskDescription.substring(2).replace('"', ' ').stripL@@eading();
