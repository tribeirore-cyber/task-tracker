error id: file://<WORKSPACE>/src/main/java/br/thomas/App.java:br/thomas/App#createNewTask#
file://<WORKSPACE>/src/main/java/br/thomas/App.java
empty definition using pc, found symbol in pc: br/thomas/App#createNewTask#
found definition using semanticdb; symbol br/thomas/App#createNewTask().
...
public class App {
    ...
    public static void main( String[] args ) throws IOException {
        ...
        Map<String, Runnable> commandMap = Map.of(
            "add", handleIO(() -> creat@@eNewTask(reader, tasks)),
