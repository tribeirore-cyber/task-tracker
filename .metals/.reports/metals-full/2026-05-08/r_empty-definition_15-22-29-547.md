error id: file://<WORKSPACE>/src/main/java/br/thomas/App.java:java/lang/Integer#parseInt(+2).
file://<WORKSPACE>/src/main/java/br/thomas/App.java
empty definition using pc, found symbol in pc: java/lang/Integer#parseInt(+2).
